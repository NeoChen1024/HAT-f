...
class Predictor(BasePredictor):
    def predict(
        ...
        try:
            ...
            res_dir = os.path.join("results", "HAT_SRx4_ImageNet-LR", "visualization", "custom")
            assert len(os.listdir(res_dir)) == 1, "Should contain only one result for Single prediction."
